                ...
                if (mproduct) {
                    ...
                    if (mSales.items[index].quantity <= mproduct.current_product_quantity) {
                        ...
                        const data = {
                            ...
                            selling_price:  mSales.items[index].incoming_price!=''&&typeof mSales.items[index].incoming_price!='undefined'?mSales.items[index].incoming_price:mSales.items[index].original_selling_price,
